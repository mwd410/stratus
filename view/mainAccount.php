        ...
        <div class="accountList">
            ...
            <div class="account animate-fade"
                ...
                <div class="accountBody expandDown"
                    ...
                    <form name="accountForm" action="/account/update"
                          method="POST">
                        <fieldset>

                            <label for="editAccountId_{{account.id}}">Account
                                ID</label>
                            <input name="id"
                        ...
                        <span class="formError"
                            ...
                            <label
                                for="editAccountName_{{account.id}}">Name</label>
                            <input name="name"
                                   required
                        ...
                        <span class="formError"
                            ...
                            <label for="editAccountAws_{{account.id}}">AWS
                                Key</label>
                            <input name="aws_key"
